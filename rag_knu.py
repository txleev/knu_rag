...
def generate_answer(question: str, context: str, use_ollama: bool = False) -> str:
    messages: List[Dict[str, str]] = [
        {"role": "system", "content": "You are a helpful assistant for Sonun university. add citation "},
        {"role": "user", "content": f"Answer the question based on the following context, in Kyrgyz language only:\n\n{context}\n\nQuestion: {question}"}
    ]
...
if __name__ == "__main__":
    # pdf_files = ["sonun.pdf"]  # Add your PDFs here
    pdf_files = ["Legendary_Brothers_Beksultan_Nursultan.pdf", "tekken_lore.pdf"]  # Add your PDFs here
    all_chunks = []
    ...
    index, text_chunks = build_faiss_index(all_chunks)

    question = 'who is stronger - Jin or Beksultan?'
